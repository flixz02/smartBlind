...
bool InitializeContinousADC()
{
  ...
  esp_err_t ret = adc_digi_filter_set_config()
  ...
  adc_pattern[0].channel = ADC1_CHANNEL_0;
  adc_pattern[0].unit = GET_UNIT(ADC1_CHANNEL_0);
